...
*/
    ...
    @ManyToMany
    @JoinTable(
        name = "rezept_kommentar",
        joinColumns = @JoinColumn(name = "rezept_id"),
        inverseJoinColumns = @JoinColumn(name = "kommentar_id")
    )
    ...
    public Integer getZeitaufwand() { return zeitaufwand; }
    public void setZeitaufwand(Integer zeitaufwand) { this.zeitaufwand = zeitaufwand; }

    public Schwierigkeitsgrad getSchwierigkeitsgrad() { return schwierigkeitsgrad; }
    ...
    public void setKommentare(List<Kommentar> kommentare) { this.kommentare = kommentare; }
